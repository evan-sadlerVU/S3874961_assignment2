...
android {
    namespace = "com.example.s3874961_assignment2"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.s3874961_assignment2"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    /*-Default Android project dependencies-*/
    ...
    /*-Retrofit (API Interaction) dependencies-*/
